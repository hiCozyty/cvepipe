variable "iso_checksum" {
  type    = string
  default = "sha256:50e0139646630f94d9036edaab1b91e9067741a196aa6205550659e867518bae"
}
...
variable "vm_name" {
  type    = string
  default = "win10-1903-x64-enterprise-template"
}
...
locals {
  template_description = "Windows 10 1903 Enterprise 64-bit template built ${legacy_isotime("2006-01-02 03:04:05")} username:password => localuser:password"
}

source "proxmox-iso" "win10-1903-x64-enterprise" {
...
build {
  sources = ["source.proxmox-iso.win10-1903-x64-enterprise"]
